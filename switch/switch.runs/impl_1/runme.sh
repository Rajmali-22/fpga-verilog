...
HD_PWD='C:/Users/rajma/switch/switch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log on_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source on_1.tcl -notrace
